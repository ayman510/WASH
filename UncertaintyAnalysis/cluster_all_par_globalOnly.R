...
pairs(~WASH_km2+ AquaticArea_km2+FloodplainArea_km2+WetlandsArea_km2+Demand_Mm3yr+ReachGain_Mm3yr+Budget, data=Unc.feas, col=pam_fit$cluster,
...
image.plot(interp_habitats_clust1, xlab="Normalized Aquatic Habitat Area", ylab="Normalized FLoodplain Habitat Area", main= "Low Budget", cex.main=2.5, cex.axis= 2.5, cex.lab=2.5, 
...
image.plot(interp_habitats_clust2, xlab="Normalized Aquatic Habitat Area", ylab="Normalized FLoodplain Habitat Area", main="High Budget", cex.main=2.5, cex.axis= 2.5, cex.lab=2.5, 
           axis.args = list(cex.axis = 2.5),
           legend.args=list(text='Normalized Wetland Habitat Area', side=1, line=2.5, cex=2.5), horizontal = TRUE)
